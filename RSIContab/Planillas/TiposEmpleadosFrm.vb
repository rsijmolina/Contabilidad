Public Class TiposEmpleadosFrm

    Private Sub TiposEmpleadosFrm_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub TiposEmpleadosFrm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: esta línea de código carga datos en la tabla 'PLTiposEmpleadosDataSet.PLTiposEmpleados' Puede moverla o quitarla según sea necesario.
        Me.PLTiposEmpleadosTableAdapter.Connection.ConnectionString = strcnCAD
        Me.PLTiposEmpleadosTableAdapter.Fill(Me.PLTiposEmpleadosDataSet.PLTiposEmpleados)
        Me.MdiParent = MDIPrincipal
        Me.Top = 10
        Me.Left = 10

        DataNavBarPrincipal.toolstriptextBuscar.ToolTipText = "Buscar por Código de Tipo de Empleado"
    End Sub
    ...
    Private Sub DataNavBarPrincipal_BuscarRegistroClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataNavBarPrincipal.BuscarRegistroClick
        Try
            Me.PLTiposEmpleadosTableAdapter.FillByCodigoTipoEmpleado(Me.PLTiposEmpleadosDataSet.PLTiposEmpleados, DataNavBarPrincipal.toolstriptextBuscar.Text)
    ...
    Private Sub DataNavBarPrincipal_GuardarRegistroClick(ByVal sender As Object, ByVal e As System.EventArgs, ByRef Cancelar As Boolean) Handles DataNavBarPrincipal.GuardarRegistroClick
        ...
        If DataNavBarPrincipal.ValidacionCorrecta = True Then
            Try
                ...
                Me.PLTiposEmpleadosTableAdapter.Update(Me.PLTiposEmpleadosDataSet.PLTiposEmpleados)
