Public Class SedesFrm

    Private Sub SedesFrm_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub SedesFrm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: esta línea de código carga datos en la tabla 'PLSedesDataSet.PLSedes' Puede moverla o quitarla según sea necesario.
        Me.PLSedesTableAdapter.Connection.ConnectionString = strcnCAD
        Me.PLSedesTableAdapter.Fill(Me.PLSedesDataSet.PLSedes)
        Me.MdiParent = MDIPrincipal
        Me.Top = 10
        Me.Left = 10

        DataNavBarPrincipal.toolstriptextBuscar.ToolTipText = "Buscar por Código de Sede"
    End Sub
    ...
    Private Sub DataNavBarPrincipal_BuscarRegistroClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataNavBarPrincipal.BuscarRegistroClick
        Try
            Me.PLSedesTableAdapter.FillByCodigoSede(Me.PLSedesDataSet.PLSedes, DataNavBarPrincipal.toolstriptextBuscar.Text)
    ...
    Private Sub DataNavBarPrincipal_GuardarRegistroClick(ByVal sender As Object, ByVal e As System.EventArgs, ByRef Cancelar As Boolean) Handles DataNavBarPrincipal.GuardarRegistroClick
        ...
        If DataNavBarPrincipal.ValidacionCorrecta = True Then
            Try
                ...
                Me.PLSedesTableAdapter.Update(Me.PLSedesDataSet.PLSedes)
