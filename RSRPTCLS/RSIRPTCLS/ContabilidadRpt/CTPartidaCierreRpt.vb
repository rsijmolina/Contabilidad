...
Public Class CTPartidaCierreRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RSIRPTCLS.CTPartidaCierreRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCTPartidaCierreRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CTPartidaCierreRpt = New CTPartidaCierreRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
