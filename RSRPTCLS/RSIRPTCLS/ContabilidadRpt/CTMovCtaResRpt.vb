...
Public Class CTMovCtaResRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RSIRPTCLS.CTMovCtaResRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCTMovCtaResRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CTMovCtaResRpt = New CTMovCtaResRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
