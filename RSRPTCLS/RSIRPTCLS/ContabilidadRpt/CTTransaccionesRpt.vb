...
Public Class CTTransaccionesRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RSIRPTCLS.CTTransaccionesRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCTTransaccionesRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CTTransaccionesRpt = New CTTransaccionesRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
