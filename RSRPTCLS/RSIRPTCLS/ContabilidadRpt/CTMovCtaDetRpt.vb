...
Public Class CTMovCtaDetRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RSIRPTCLS.CTMovCtaDetRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ImprimirConceptoPartida() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCTMovCtaDetRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CTMovCtaDetRpt = New CTMovCtaDetRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
