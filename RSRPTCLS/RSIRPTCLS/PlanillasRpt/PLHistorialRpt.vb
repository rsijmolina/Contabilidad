...
Public Class PLHistorialRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RSIRPTCLS.PLHistorialRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPLHistorialRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PLHistorialRpt = New PLHistorialRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
