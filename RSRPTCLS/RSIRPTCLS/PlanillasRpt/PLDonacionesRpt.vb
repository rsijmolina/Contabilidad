...
Public Class PLDonacionesRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RSIRPTCLS.PLDonacionesRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPLDonacionesRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PLDonacionesRpt = New PLDonacionesRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
