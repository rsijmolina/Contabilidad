...
Public Class PLSalPendEmp2Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RSIRPTCLS.PLSalPendEmp2Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPLSalPendEmp2Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PLSalPendEmp2Rpt = New PLSalPendEmp2Rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
