...
Public Class PLSalPendEmp1Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RSIRPTCLS.PLSalPendEmp1Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPLSalPendEmp1Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PLSalPendEmp1Rpt = New PLSalPendEmp1Rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
