...
Public Class PLSeguroSocialRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RSIRPTCLS.PLSeguroSocialRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPLSeguroSocialRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PLSeguroSocialRpt = New PLSeguroSocialRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
